...
public class Arrow extends Polygon
	...
	public static int[] polyXArray = {-10,-10,0,0,10,0,0,-10};
	public static int[] polyYArray = {-6,-12,-12,-18,-9,0,-6,-6};
	
	private int rWidth = 20, rHeight = 18;	
	...
	public Arrow()
			...
			if(Math.random()<0.5) 
						{
							this.activ=false;
							GameBoard.w2debug("Arrow disabled");
						}
			else        {
			this.activ=true;
			GameBoard.w2debug("This Arrow flies");
						}
			this.onScreen=true;
			a+=1;
			GameBoard.w2debug("That was arrow number:"+String.valueOf(a));
			}
