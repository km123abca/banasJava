...
public class PhotonTorpedo extends Polygon{
	...
	private int motherShip=9999;
	
	public PhotonTorpedo(double centerX, double centerY, double movingAngle,int ms){
	...
	public int getMotherShip(){return this.motherShip;}
	public void setMotherShip(int x){this.motherShip=x;}

	public int getTotDist(){return this.totDist;}
	public void incToDist()
		{	this.totDist+=1;
			if(this.totDist>1000) 
				this.totDist=0;
		}
