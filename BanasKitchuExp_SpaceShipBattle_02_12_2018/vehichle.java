...
class vehichle extends Polygon{
	...
	static ArrayList<vehichle> vehichles = new ArrayList<vehichle>();
	...
	int width = Road.boardWidth;
	int height = Road.boardHeight;
	...
	public static int[] spolyXArray = {-10,10,10,-10,-10};
	public static int[] spolyYArray = {-10,-10,10,10,-10};
	...
	public vehichle(int[] polyXArray, int[] polyYArray, int pointsInPoly, int randomStartXPos, int randomStartYPos){
