...
public class Lesson36{
	...
	public static void main(String[] args){
        ...
        try {
            ...
            conn = DriverManager.getConnection("jdbc:mysql://localhost/lahman2016","root","sonja");
            ...
            String selectStuff = "select b.yearID, b.playerID, " +
            		...
            		"((b.H+b.BB)+(2.4*(b.AB+b.BB)))*(0+(3*(b.AB+b.BB)))/(9*(b.AB+b.BB))-(.9*(b.AB+b.BB)) AS TTRC, " +
            		"b.teamID AS Team, s.salary AS Salary, " +
            		"CAST( s.salary/(((b.H+b.BB)+(2.4*(b.AB+b.BB)))*(0+(3*(b.AB+b.BB)))/(9*(b.AB+b.BB))-(.9*(b.AB+b.BB))) as decimal(10,2)) AS CPR, " +
            		"f.POS AS POS FROM Batting b, Master m, Salaries s,  Fielding f " +
            		"WHERE b.playerID = m.playerID  " +
            		"AND b.yearID = 2010  AND s.playerID = b.playerID " + 
