		...
		public tone()
			{
				...
				thePanel.add(commaSeperator,true);
				...
				//Border operBorder= BorderFactory.createTitleBorder("Operation");
					...
					if (e.getSource()==button1)
						{
							try
							    ...
							    {
							    		JOptionPane.showMessageDialog(tone.this,"Please Enter right info","title:Error",JOptionPane.ERROR_MESSAGE);
							    		System.exit(0);
							    }
						...
						if (dollarSign.isSelected())
							{
								...
								JOptionPane.showMessageDialog(tone.this,numFormat.format(totalCalc),"Solution",JOptionPane.INFORMATION_MESSAGE);
						...
						else
							{
								...
								JOptionPane.showMessageDialog(tone.this,totalCalc,"Solution",JOptionPane.INFORMATION_MESSAGE);	
							}	
